  ...
  return (
    <div className="modal-overlay">
      <div className="modal-content glass-panel" style={{ padding: "24px" }}>
        <h2>データを読み込む</h2>
        <input className="pop-input" value={code} onChange={(e) => setCode(e.target.value)} placeholder="引き継ぎコード (例: XXXX-XXXX)" />
        <button onClick={handleRestore} className="btn-pop" style={{ width: "100%", marginTop: "16px" }} disabled={loading}>
